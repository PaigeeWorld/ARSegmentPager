#
#  Be sure to run `pod spec lint ARSegmentPager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of ARSegmentPager in Markdown format.
  ...
  s.source       = { :git => "https://github.com/AugustRush/ARSegmentPager.git", :tag => "1.0" }
